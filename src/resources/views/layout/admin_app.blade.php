...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/layout/admin_common.css')}}">
        ...
        <div class="header__menu">
            <nav class="header__nav">
                <ul class="header__nav-list">
                    ...
                    <li class="header__nav-item">
                        <a href="{{route('admin-staff.list.show')}}" class="header__nav-link">スタッフ一覧</a>
                    </li>
                    <li class="header__nav-item">
                        <a href="{{route('stamp-correction-request.list')}}" class="header__nav-link">申請一覧</a>
                    </li>
                    <li class="header__nav-item">
