...
<div class="detail">
    <div class="detail__group">
        ...
        <div class="detail__field">
            <form action="{{route('user-attendance.request.store', $attendance->id)}}" method="post" class="detail__form">
                @csrf
                <div class="detail__form--group">
                    ...
                    <div class="detail__form--row">
                        ...
                        <input type="datetime" name="after_break_in_at[]" value="{{$break->break_in_at?->format('H:i')}}" class="detail__form--input">
                        <span class="input__modifier">〜</span>
                        <input type="datetime" name="after_break_out_at[]" value="{{$break->break_out_at?->format('H:i')}}" class="detail__form--input">
                    </div>
                    @endforeach
                    <div class="detail__form--row">
                        <label for="" class="detail__form--label">休憩{{$attendance->restBreaks->count() + 1}}</label>
                        <input type="datetime" name="after_break_in_at[]" id="" class="detail__form--input">
                        <span class="input__modifier">〜</span>
                        <input type="datetime" name="after_break_out_at[]" id="" class="detail__form--input">
                    </div>
                    <div class="detail__form--row">
